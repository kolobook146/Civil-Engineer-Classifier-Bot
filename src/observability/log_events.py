...
class LogEvent(StrEnum):
    ...
    dashboard_export_requested = "dashboard_export_requested"
    dashboard_export_succeeded = "dashboard_export_succeeded"
    dashboard_export_failed = "dashboard_export_failed"
    dashboard_pdf_requested = "dashboard_pdf_requested"
    dashboard_pdf_sent = "dashboard_pdf_sent"
    dashboard_pdf_failed = "dashboard_pdf_failed"
